...
MODULE_DESCRIPTION("Apogee CCD camera PCI Interface");
MODULE_LICENSE("GPL");
...
struct file_operations appci_fops = {
#if (LINUX_VERSION_CODE >= 0x20400)
...
/*     outl(PLX_CNTRL_EEPROM_RELOAD,PLXBAR1+PLX_CNTRL); */
    ...
    PLXBAR2&=PCI_BASE_ADDRESS_MEM_MASK; 
    printk("<1>appci: memory 2 starts at 0x%08lx\n", (unsigned long) PLXBAR2);
    boards[boardsInUse] = ioremap(PLXBAR2,256);  
